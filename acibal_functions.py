...
"""
# boolen cat_cols'larda grafik sıkıntısı oluşuyor. ARTIK SORUN KALMADI.
for col in cat_cols:
...
# SORUN KALMADIĞINDAN DİREK BUNU KULLANABİLİRİZ.
for col in cat_cols:
    cat_summary(dataframe, col, plot=True)
"""
...
# q1=0.01 & q3=0.99 ucundan kırpma daha sağlıklı
...
"""
binary_cols = [col for col in dataframe.columns if (str(dataframe[col].dtypes) in ["category", "object", "bool"]) & (dataframe[col].nunique() == 2)]
...
# num=len(X.columns) yapabilirsin kullanırken
